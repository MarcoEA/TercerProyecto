...
public class Smart extends Thread {
    ...
    public Smart(SynchronizedBuffer myBuffer, Maze myMaze, int coordX, int coordY, String name)
            throws IOException {
        this.setName("Smart");
        this.nameC = name;
        this.myMaze = myMaze;
        ...
        this.coordX = coordX;
        this.coordY = coordY;
        this.image = ImageIO.read(new File("./ProjectImages/JakeFrente2.png"));
        this.wall = false;
        this.sleepTime = 1500;
        this.pause = false;
        this.run = true;
    ...
    public void run() {
        ...
        while (run == true) {
            ...
            while (true) {
                ...
                //el personaje se mueve por el laberinto, si choca contra un muro o personaje cambia de dirección
                if (random == 0) {
                    if (getCoordX() - 1 >= 0) {
                        ...
                        if (getMyBuffer().get(getCoordY(), getCoordX() - 1) == 4) {
                            ...
                            myMaze.repaint();
                            myMaze.deleteSmart(this.getNameC());
                            ...
                            break;
                        }//Si se encuentra con el item aumenta la velocidad y elimina el item
