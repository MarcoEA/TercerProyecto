...
public class Fast extends Thread {
    ...
    //método para controlar los movimientos del personaje fast
    @Override
    public void run() {
        if (fastLoading == true) {
        ...
        while (run == true) {
            //while para pausar el personaje fast en el juego
            while (pause == true) {
                try {
                    Thread.sleep(500);
                } catch (InterruptedException ex) {
            ...
            } // if para cargar las imagenes donde el persona se está cargando
                        ...
                        if (getMyBuffer().get(getCoordY(), getCoordX() - 1) == 4) {
                            ...
                            if (myMaze.getWinner() == 0) {
                                ...
                                try {
                                    ...
                                    Logger.getLogger(Fast.class.getName()).log(Level.SEVERE, null, ex);
                                }//si ya hay un ganador se activa el sonido de gane
                                for (int i = 0; i < 30; i++) {
                                    try {
                                        Thread.sleep(70);
                                    } catch (InterruptedException ex) {
