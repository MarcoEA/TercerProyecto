...
public class MainWindow extends JFrame implements ActionListener, MouseListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (lblImageLevel1.isEnabled() == true) {
            ...
            path = "./ProjectImages/fincasa.jpg";
        } else if (lblImageLevel2.isEnabled() == true) {
            level = "MazeLevel2";
            entranceExit = new int[4];
            path = "./ProjectImages/reinodulce.png";
        } else {
            level = "MazeLevel3";
            entranceExit = new int[8];
            path = "./ProjectImages/reinoheladodos.png";
        }// dependiendo del laberinto elegido el path envie una ruta con un fondo diferente
        ...
        if ((fast + furious + smart) != 0) {
            try {
                ...
                String soundName = "./Sounds/jake.wav";
            ...
            try {
                this.animationWindow = new AnimationWindow(fast, furious, smart, 1, blocks, entranceExit, path);
            } catch (IOException ex) {
                Logger.getLogger(MainWindow.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
